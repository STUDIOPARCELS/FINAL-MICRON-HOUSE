    ...
    <section id="prototype" className="container mx-auto px-8 md:px-12 pt-0 pb-6 md:pb-12 text-zinc-900">
        ...
        >
            <div className="flex-shrink-0">
                <span className="block text-sm font-bold uppercase tracking-[0.2em] text-zinc-400 mb-2 font-sans">01 / VISION</span>
            ...
            <div className="md:ml-auto max-w-2xl pb-1">
                <div className="md:pl-6 md:border-l-4 md:border-micron-eggplant/20 md:hover:border-micron-eggplant md:transition-colors md:duration-500">
                    <div className="text-base font-light text-zinc-600 leading-snug font-body">
                        ...
                        >
                            The opportunity to shape policy and narrative is now. Every stakeholder in the autonomous future — Micron, Tesla, policymakers, and civic leaders — must experience the technology in a real house and neighborhood to build frameworks that earn public trust. <strong className="font-semibold text-zinc-800">5 min from the capitol and downtown, and 15 min from Micron and airport.</strong>
                        </motion.span>
                    </div>
                </div>
            </div>
