...
const getCardData = (id: number): ModalContent => {
  ...
  switch(id) {
    case 1: return { 
        ...base, 
        title: 'prototype', 
        modalLayout: 'default', // Standard: Text Left, Image Right (Portrait Bento)
        image: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2070&auto=format&fit=crop', // Abstract Tech
        content: (
    ...
    case 2: return { 
        ...base, 
        title: 'timing', 
        modalLayout: 'reverse', // Reverse: Image Left (Portrait Bento), Text Right
        image: 'https://images.unsplash.com/photo-1445583934509-4ad52d4e9555?q=80&w=2070&auto=format&fit=crop', // Nature/Boise
    ...
    case 3: return { 
        ...base, 
        title: 'collaboration', 
        modalLayout: 'vertical-text-top', // Vertical: Text Top, Image Bottom (Landscape Bento)
        image: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=2070&auto=format&fit=crop', // Collaboration/Tech
    ...
    case 4: return { 
        ...
        modalLayout: 'vertical-image-top', // Vertical: Image Top (Landscape Bento), Text Bottom
        image: 'https://images.unsplash.com/photo-1600596542815-2a4d9fdb52d9?q=80&w=2075&auto=format&fit=crop', // Home/Architecture
        content: (
        <div>
...
export const SectionPrototype: React.FC = () => {
  ...
  // Updated styles: Uppercase, Sans-serif (removed font-micron), Text-2XL
  const cardLabelStyle = "text-[10px] font-bold uppercase tracking-[0.2em] text-white/40 mb-auto group-hover:text-white/70 transition-colors duration-300";
  const cardTitleStyle = "text-2xl font-bold text-white mb-2 transition-colors duration-300 uppercase";
  const cardDescStyle = "text-xs text-zinc-300 font-body leading-relaxed max-w-sm group-hover:text-white transition-colors duration-300";
  ...
  return (
    <section id="prototype" className="container mx-auto px-6 py-24 md:px-12 bg-white text-zinc-900">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2">
        ...
        {/* Card 1: NOW DARKER -> bg-micron-black */}
        <BentoCard 
        ...
        {/* Card 2: Green (Micron Green) -> Hover Deep Eggplant (Better Contrast) */}
        <BentoCard 
            className="flex flex-col min-h-[350px] relative overflow-hidden" 
        ...
        {/* Card 3: Medium Gray (Micron Grey 2) -> Hover Green */}
        <BentoCard 
          className="flex flex-col min-h-[350px]" 
        ...
        {/* Card 4: Dark Eggplant (Micron Eggplant) -> Hover Green (Contrast) */}
        <BentoCard 
           className="flex flex-col min-h-[350px]" 
