        ...
        >
            ...
            <div className="hidden lg:flex flex-grow items-center justify-center relative px-2 xl:px-4 z-10">
                <motion.div
                        ...
                        animate={shouldShowQuote ? "visible" : "hidden"}
                        variants={quoteContainerVariants}
                        className="font-micron text-lg lg:text-xl xl:text-2xl text-white font-extralight leading-relaxed text-left lg:-rotate-3 xl:-rotate-6 xl:max-w-lg w-full xl:-translate-x-4 pb-4 will-change-transform"
                >
                     <p className="inline">
                        {quoteWords.map((word, i) => (
                        <motion.span
            ...
            {/* RIGHT: Map Card — shows stacked on mobile, hidden on tablet landscape, back on desktop */}
            <div className="w-full lg:hidden xl:block xl:w-[340px] aspect-[4/3] xl:aspect-auto xl:h-auto bg-zinc-100 rounded-2xl overflow-hidden shadow-2xl relative border-4 border-white/20 z-10 mt-auto xl:mt-0 flex-shrink-0">
                 <iframe
