...
const NARRATIVE = {
  ...
  briefings: {
    sectionId: 'policy',
    navLabel: 'Briefings',
    context: 'Micron House is the immediate venue to test Cybercab and Optimus in a 1906 home, convene leaders around firsthand experience — and shape public rollout from a historic neighborhood near the Capitol, downtown, Micron, and the airport.',
    legislativeBriefs: [
      {
        id: 'brief-a',
        title: 'Idaho ADS Driverless Passenger Service Act',
        model: 'Texas SB 2807',
        scope: 'Authorizes autonomous vehicle passenger service on public roads in Idaho.',
      },
      {
        id: 'brief-b',
        title: 'Idaho Robot-Enabled Building Operations Act',
        model: 'First-of-kind state legislation',
        scope: 'Authorizes autonomous robot operations within private property buildings in Idaho.',
      },
    ],
    principles: [
  ...
  useEffect(() => {
    ...
    const tools: WebMCPTool[] = [
      ...
      },
      {
        ...
        description: 'Idaho legislative briefings — ADS Driverless Passenger Service Act (Texas SB 2807 model) and Robot-Enabled Building Operations Act. Regulatory principles.',
        annotations: { readOnlyHint: true },
