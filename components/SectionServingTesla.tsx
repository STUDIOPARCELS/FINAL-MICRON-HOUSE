...
const teslaCards = [
  ...
  // CARD 3: GENESIS
  {
    ...
    content: "Aligning a Boise property with the future Micron and Tesla are leading.",
    icon: null,
      ...
      <section id="serving-tesla" className="container mx-auto px-8 md:px-12 pt-12 pb-6 md:pb-12 text-zinc-900 overflow-hidden">
          ...
          >
              <div className="flex-shrink-0">
                  <span className="block text-sm font-bold uppercase tracking-[0.2em] text-zinc-400 mb-2 font-sans">04 / IN PRACTICE</span>
