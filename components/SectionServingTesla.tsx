...
const teslaCards = [
  { 
    ...
    icon: <ScanFace size={24} className="text-white" />,
    colSpan: "md:col-span-2",
    gradient: "bg-black" // Deepest black
  },
  { 
    id: 2, 
    title: "CYBERCAB HUB", 
    ...
    icon: <BatteryCharging size={24} className="text-micron-green" />,
    colSpan: "md:col-span-1",
    gradient: "bg-zinc-800" // Lighter gray
  },
  { 
    id: 3, 
    ...
    colSpan: "md:col-span-1",
    gradient: "bg-zinc-900" // Middle gray
  },
  { 
    id: 4, 
    ...
    colSpan: "md:col-span-2",
    gradient: "bg-micron-green" // ACCENT
  }
];
    ...
    <section id="serving-tesla" className="container mx-auto px-6 py-24 md:px-12 bg-white text-zinc-900">
      ...
      <div className="mb-20 flex flex-col md:flex-row md:items-end gap-6 border-b border-zinc-200 pb-8">
        <div>
           ...
           <h2 className="text-5xl md:text-6xl font-bold font-micron uppercase tracking-tight text-zinc-900 leading-none">SERVING TESLA</h2>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {teslaCards.map((card, i) => (
          <BentoCard 
            key={card.id} 
            className={`group flex flex-col justify-between min-h-[225px] ${card.colSpan} border border-white/5`}
          ...
          >
            <div className="flex justify-between items-start mb-6">
               <div className="p-2 rounded-full bg-white/10 border border-white/5 backdrop-blur-sm group-hover:bg-white/20 transition-colors">
                  {card.icon}
               </div>
            ...
            <div className="mt-auto">
               ...
               <p className="text-white/60 font-body text-xs leading-relaxed max-w-md line-clamp-2">
                 {card.content}
               </p>
            </div>
