...
import { MapPin, Plane, Building2, Leaf, GraduationCap, Stethoscope, Home, ArrowUp, ArrowUpRight, Cpu, TreeDeciduous, Zap, Waves, Activity, Sprout, Car, Bot, History, Landmark, FileText, X } from 'lucide-react';
...
export const SectionProperty: React.FC = () => {
  ...
  return (
    <section id="property" className="container mx-auto px-8 md:px-12 pt-12 pb-6 md:pb-12 text-zinc-900">
        <motion.div
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.1 }}
            ...
            <div className="md:ml-auto max-w-2xl pb-1">
                 <div className="md:pl-6 md:border-l-4 md:border-micron-eggplant/20 md:hover:border-micron-eggplant md:transition-colors md:duration-500">
                    <div className="text-base font-light text-zinc-600 leading-snug font-body">
                       ...
                       <p>
                           Warm Springs gives Micron House historic depth, residential privacy, geothermal grounding, and direct access to Boise's institutional ecosystem where Micron, Tesla, the Capitol, major hospital systems, Boise State, and <strong className="font-semibold text-zinc-800">cross-sector leaders come together to prepare our communities</strong> for the smooth integration of autonomous technology at scale. <strong className="font-semibold text-zinc-800">5 min from the capitol and downtown, 15 min from Micron and airport.</strong>
                       </p>
                    </div>
                 </div>
            </div>
