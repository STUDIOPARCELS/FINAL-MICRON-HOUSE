  ...
  return (
    <div className="min-h-screen w-full bg-white text-zinc-900 font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] bg-white/95 backdrop-blur-xl border-b border-zinc-200 shadow-sm transition-colors duration-300">
        <div className="container mx-auto px-4 md:px-6 py-[0.9rem] flex items-center justify-between relative z-[110]">
            {/* ANIMATED BRAND LOGO */}
            <div
            ...
            >
              <motion.img
                ...
                className="h-[3.77rem] w-[3.77rem] md:h-[4.42rem] md:w-[4.42rem] object-contain"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ 
                  duration: 1.5, 
